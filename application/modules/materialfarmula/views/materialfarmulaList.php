	...
	<div class="main-content-inner">
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li class="active">Material Farmula</li>
			</ul><!-- /.breadcrumb -->
					...
					<div class="row">
						<div class="col-xs-12">
								<button class="btn btn-info test" type="submit">
									<a href="<?php echo site_url('materialfarmula/materialfarmulaMaster'); ?>"><i class="fa fa-plus"></i>Add Material Farmula</a>
								</button>
											...
											<tr>
												...
												<td>
													<div class="hidden-sm hidden-xs action-buttons">
														<a class="green" href="<?php echo site_url('/materialfarmula/materialfarmulaMaster/'.$val->SrNo); ?>">
