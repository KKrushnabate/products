    ...
    <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="<?php echo site_url('/currency/index'); ?>">Metal Plate</a>
                </li>
                <li class="active">Add Metal Plate</li>
            </ul><!-- /.breadcrumb -->
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="alert-box"></div>
                        <!-- PAGE CONTENT BEGINS -->
                            <?php
                                $strFormId = "metalplatemaster";
                                $arrAttributers = array("class"=>"form-horizontal", "role"=>"form","id"=>$strFormId);
                                echo form_open('',$arrAttributers); 
                            ?>
                            <div class="form-group">
                                <label class="col-sm-2 no-padding-right" for="form-field-2">Profile Name*</label>
                                ...
                                <div class="col-sm-9">
                                    ...
                                    $data = array(
                                        'name'          => 'ProfileName',
                                        'id'            => 'ProfileName',
                                        'value'         => (!empty($metalPlatedata[0])) ? $metalPlatedata[0]->ProfileName: '',
                                        'maxlength'     => '45',
                                        "placeholder"   => "Enter Currency Name",
                                        "class"         => "col-xs-10 col-sm-5 mandatory-field"
                                        );
                                    if(!empty($metalPlatedata[0]->SrNo)){$data["readonly"]      = "readonly";}
                                        echo form_input($data);
                                    ?>
                                        <span class="help-inline col-xs-12 col-sm-7">
                                                <span class="middle input-text-error" id="ProfileName_errorlabel"></span>
                                        </span>
                                </div>
                            </div>
                                        
                            <div class="form-group">
                                <label class="col-sm-2 no-padding-right" for="form-field-2">No Of Plate RU*</label>
                                ...
                                <div class="col-sm-9">
                                    ...
                                    $data = array(
                                        'name'          => 'NoOfPlateRU',
                                        'id'            => 'NoOfPlateRU',
                                        'value'         => (!empty($metalPlatedata[0])) ? $metalPlatedata[0]->NoOfPlateRU: '',
                                        'maxlength'     => '100',
                                        "placeholder"   => "No Of Plate RU",
                                        "class"         => "col-xs-10 col-sm-5 mandatory-field"
                                        );
                                        echo form_input($data);
                                    ?>
                                        <span class="help-inline col-xs-12 col-sm-7">
                                                <span class="middle input-text-error" id="NoOfPlateRU_errorlabel"></span>
                                        </span>
                                </div>
                            </div>
                        
                            <div class="form-group">
                                <label class="col-sm-2 no-padding-right" for="form-field-2"> No Of Plat ePU*</label>
                                ...
                                <div class="col-sm-9">
                                    ...
                                    $data = array(
                                        'name'          => 'NoOfPlatePU',
                                        'id'            => 'NoOfPlatePU',
                                        'value'         => (!empty($metalPlatedata[0])) ? $metalPlatedata[0]->NoOfPlatePU: '',
                                        'maxlength'     => '45',
                                        "placeholder"   => "No Of Plate PU",
                                        "class"         => "col-xs-10 col-sm-5 mandatory-field"
                                        );
                                        echo form_input($data);
                                    ?>
                                        <span class="help-inline col-xs-12 col-sm-7">
                                                <span class="middle input-text-error" id="NoOfPlatePU_errorlabel"></span>
                                        </span>
                                </div>
                            </div>
                            
                            <div class="form-group">
                                <label class="col-sm-2 no-padding-right" for="form-field-2"> No Of Metal*</label>
                                ...
                                <div class="col-sm-9">
                                    ...
                                    $data = array(
                                        'name'          => 'NoOfMetal',
                                        'id'            => 'NoOfMetal',
                                        'value'         => (!empty($metalPlatedata[0])) ? $metalPlatedata[0]->NoOfMetal: '',
                                        'maxlength'     => '45',
                                        "placeholder"   => "Enter No Of Metal",
                                        "class"         => "col-xs-10 col-sm-5 mandatory-field"
                                        );
                                    ...
                                    ?>
                                        <span class="help-inline col-xs-12 col-sm-7">
                                                <span class="middle input-text-error" id="NoOfMetal_errorlabel"></span>
                                        </span>
                                </div>
                            </div>
                        
                            <div class="form-group">
                                <label class="col-sm-2 no-padding-right" for="form-field-2"> Cup Spring*</label>
                                ...
                                <div class="col-sm-9">
                                    ...
                                    $data = array(
                                        'name'          => 'CupSpring',
                                        'id'            => 'CupSpring',
                                        'value'         => (!empty($metalPlatedata[0])) ? $metalPlatedata[0]->CupSpring: '',
                                        'maxlength'     => '45',
                                        "placeholder"   => "Enter Cup Spring",
                                        "class"         => "col-xs-10 col-sm-5 mandatory-field"
                                        );
                                    ...
                                    ?>
                                        <span class="help-inline col-xs-12 col-sm-7">
                                                <span class="middle input-text-error" id="CupSpring_errorlabel"></span>
                                        </span>
                                </div>
                            </div>
