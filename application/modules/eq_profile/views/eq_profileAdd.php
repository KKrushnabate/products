    ...
    <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="<?php echo site_url('/currency/index'); ?>">Equivalent Profile</a>
                </li>
                <li class="active">Add Equivalent Profile</li>
            </ul><!-- /.breadcrumb -->
